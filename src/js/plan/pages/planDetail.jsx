                            ...
                            <div className="plan-map-div" >
                                {this.state.planMapList.length-1 > 0 ?
                                    this.state.planMapList.map((obj, index) => (
                                        index == 0 ?
                                        <NavLink exact={true} key={index} className="plan-map-a" activeClassName="plan-map-chk" to={"/plan/planDetail"}>Day - {index+1}</NavLink>
                                        : 
                                        <NavLink key={index} className="plan-map-a" activeClassName="plan-map-chk" to={"/plan/planDetail/Day" + (index+1)}>Day - {index+1}</NavLink>
                                    )
                                    )
                                    :
                                        ""
