                            ...
                            <div className="plan-sche-div">
                                <table className="plan-sche-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <img className="plan-table-btn-settingGray" src="../../../assets/images/btn/settingGray.png" />
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img className="plan-table-btn-location" src="../../../assets/images/btn/location.png" />
                                            </td>
                                            <td>
                                                인사동 쌈지길
                                            </td>
                                        ...
                                        <tr className="plan-table-sche-tr">
                                            ...
                                            <td>
                                                <img className="plan-table-btn-schedule" src="../../../assets/images/btn/schedule.png" />
                                            </td>
                                            <td>
                                                남산타워에서 쉼.
                                            </td>
                                ...
                                <table className="plan-sche-table-bottom">
                                    <thead>
                                        <tr>
                                            <th colSpan="2">
                                                <img className="plan-table-btn-add" src="../../../assets/images/btn/addblack.png" />
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
